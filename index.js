...
const fs = require('fs');
// Array of questions for user README inputs
const questions = [
    {
        type: 'input',
        name: 'title',
    ...
    },
    {
        type: 'input',
        name: 'how',
        message: 'How can a user utilize this project? (Required)',
        validate: howInput => {
            if (howInput) {
                return true;
            } else {
    ...
    },
    {
        type: 'input',
        name: 'installation',
        message: 'Please provide a step by step instruction of the installation for your project. (Required)',
